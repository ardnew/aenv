// Package pprof provides optional runtime profiling for the envcomp
// application.
//
// # Overview
//
...
// # Command-Line Usage
//
// The envcomp command supports profiling through command-line flags when built
// with the pprof tag:
//
//	# Enable CPU profiling (writes to default cache directory)
//	./envcomp -pprof-mode cpu
//
//	# Enable heap profiling with custom output directory
//	./envcomp -pprof-mode heap -pprof-dir ./profiles
//
...
//
//	$XDG_CACHE_HOME/envcomp/pprof   (Linux/Unix)
//	~/Library/Caches/envcomp/pprof  (macOS)
//	%LocalAppData%\envcomp\pprof    (Windows)
//
...
//	go tool pprof ./envcomp /tmp/profiles/cpu.pprof
//
