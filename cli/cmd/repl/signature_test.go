  ...
  multiply a b : a * b
	...
	tests := []struct {
		...
		},
		{
			name:          "builtin fs.cat",
			funcName:      "fs.cat",
			wantSignature: "fs.cat(...string)",
			wantParams:    []string{"...string"},
		},
		{
			name:          "builtin fs.rel",
			funcName:      "fs.rel",
			wantSignature: "fs.rel(string, string)",
			wantParams:    []string{"string", "string"},
		},
		{
			name:          "builtin mung",
			funcName:      "mung",
			wantSignature: "mung(string, string, ...string)",
			wantParams:    []string{"string", "string", "...string"},
		},
		{
			name:          "builtin mungif",
			funcName:      "mungif",
			wantSignature: "mungif(string, string, func, ...string)",
			wantParams:    []string{"string", "string", "func", "...string"},
		},
		{
