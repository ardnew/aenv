...
var nextState = []func(r rune) state{
	...
	func(r rune) state {
		switch {
		case unicode.In(r, _L, _Nl, _Other_ID_Start, _Mn, _Mc, _Nd, _Pc, _Other_ID_Continue) && !unicode.In(r, _Pattern_Syntax, _Pattern_White_Space):
			return 10
		case any(r, []rune{'+', '-', '.', '/', '@'}):
			return 24
		}
